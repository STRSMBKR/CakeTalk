...
<?php
	...
	$options = array('inputDefaults' => array('dateFormat' => 'YMD', 'timeFormat' => 24, 'monthNames' => null)
);
echo $this->Form->create(null, $options);

/*$options = array('inputDefaults' => array('dateFormat' => 'YMD', 'timeFormat' => 24, 'monthNames' => null)
);*/
echo $this->Form->inputs($scaffoldFields, array('created', 'modified', 'updated', $options));


	//echo $this->Form->inputs($scaffoldFields, array('created', 'modified', 'updated'));
	//echo $this->Form->input('birthday', array('created' => 'YMD', 'modified' => date('Y'), 'updated' => date('Y')-100, 'monthNames' => false));
